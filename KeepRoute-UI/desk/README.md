...
- Default gateway URL when using this package's compose file: `http://127.0.0.1:20127`
  (host maps 20127 → container 20128). Always export:
  `OMNIROUTE_HOST=http://127.0.0.1:20127`
